...
Go applications can use `process.NewMonitor` in `pkg/process` to construct one
Linux process monitor, receive the existing lifecycle callbacks, and release its resources
